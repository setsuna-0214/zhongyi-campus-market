...
public class AiService {
    ...
    private String buildVLSystemPrompt() {
        return """
                ...
                2. **绝对禁止**使用"同学,..."、"你好"等打招呼内容及"这是我的..."等卖家自我介绍内容。
                3. **绝对禁止**使用"这张图片展示了..."、"图片中..."、"可以看出..."、"图中..."等以第三人称观察者角度描述图片的措辞。
                4. **绝对禁止**出现对自己或他人身份的描述（如："我是..."、"我叫..."、"我是...的..."等）。
                5. **绝对禁止**出现对商品价格的描述（如："这个商品价格是..."、"这个商品价格是...元"等）。
                6. **结合标题**：如果提供了商品标题，请务必结合标题信息来确认物品型号/书名/角色等，确保准确。
                7. **识别类别**：如果用户未指定分类，你必须根据图片判断它属于以下哪一类：
                   - electronics (数码电子)
                   - books (图书教材)
                   - daily (生活用品)
                   - other (其他物品)
